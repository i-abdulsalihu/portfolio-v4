    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <MotionTrigger y={0}>
          ...
          >
            <FiSun className="!size-[19px] scale-100 rotate-0 transition-all dark:scale-0 dark:-rotate-90" />
            <PiCloudMoonDuotone className="absolute !size-[19px] scale-0 rotate-90 transition-all dark:scale-100 dark:rotate-0" />
